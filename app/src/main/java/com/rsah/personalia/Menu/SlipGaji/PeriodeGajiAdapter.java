...
public class PeriodeGajiAdapter extends RecyclerView.Adapter<PeriodeGajiAdapter.AdapterHolder>{

    List<ResponseEntityPeriode> AllPaymentItemList;
    Context mContext;


    public PeriodeGajiAdapter(Context context, List<ResponseEntityPeriode> paymentList){
    ...
    public void onBindViewHolder(AdapterHolder holder, int position) {
        ...
        holder.cv_row.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TAG_PERIODE = tahunID ;
                mContext.startActivity(new Intent(mContext,slipGaji.class));
            }
        });
