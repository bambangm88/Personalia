...
public class nilai_4_pwt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nilai_4_pwt);
        ...
        btn_selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai_1_.equals("-- Nilai --")){
                    ...
                    TAG_KERJA_SAMA_1 = Helper.nilaiHurufToNumber_Bidan(nilai_1_) ;
                    TAG_KERJA_SAMA_2 = Helper.nilaiHurufToNumber_Bidan(nilai_2_) ;
                    TAG_KERJA_SAMA_3 = Helper.nilaiHurufToNumber_Bidan(nilai_3_) ;


                    sessionManager.createKerja_sama(Helper.nilaiHurufToNumber_Bidan(nilai_1_),Helper.nilaiHurufToNumber_Bidan(nilai_2_) ,Helper.nilaiHurufToNumber_Bidan(nilai_3_) ,"","");


                    startActivity(new Intent(mContext, nilai_5_pwt.class));
