...
import com.rsah.personalia.Menu.TeamSaya.Penilaian.signature;
...
public class nilai_6_pwt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nilai_6_pwt);
        ...
        btn_selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai_1_.equals("-- Nilai --")){
                    ...
                    TAG_KERAJINAN_1 = Helper.nilaiHurufToNumber_Bidan(nilai_1_)  ;
                    TAG_KERAJINAN_2 = Helper.nilaiHurufToNumber_Bidan(nilai_2_) ;


                    sessionManager.createKerajinan(Helper.nilaiHurufToNumber_Bidan(nilai_1_) ,Helper.nilaiHurufToNumber_Bidan(nilai_2_) ,"","","");

                    startActivity(new Intent(mContext,signature.class));
