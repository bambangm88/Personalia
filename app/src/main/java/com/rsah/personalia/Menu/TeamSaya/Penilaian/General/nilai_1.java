...
public class nilai_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nilai_1);
        ...
        btn_selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai_1_.equals("")){
                    ...
                    TAG_SKILL_1 = nilai_1_ ;
                    TAG_SKILL_2 = nilai_2_ ;
                    TAG_SKILL_3 = nilai_3_ ;
                    TAG_SKILL_4 = nilai_4_ ;
                    TAG_SKILL_5 = nilai_5_ ;

                    sessionManager.createSkill(nilai_1_,nilai_2_,nilai_3_,nilai_4_,nilai_5_);

                    startActivity(new Intent(mContext,nilai_2.class));
