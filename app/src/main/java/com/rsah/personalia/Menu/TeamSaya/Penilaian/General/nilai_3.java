        ...
        btn_selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai_1_.equals("")){
                    ...
                    TAG_KEMAMPUAN_1 = nilai_1_ ;
                    TAG_KEMAMPUAN_2 = nilai_2_ ;
                    TAG_KEMAMPUAN_3 = nilai_3_ ;
                    TAG_KEMAMPUAN_4 = nilai_4_ ;
                    TAG_KEMAMPUAN_5 = nilai_5_ ;

                    sessionManager.createKemampuan(nilai_1_,nilai_2_,nilai_3_,nilai_4_,nilai_5_);

                    startActivity(new Intent(mContext,nilai_4.class));
