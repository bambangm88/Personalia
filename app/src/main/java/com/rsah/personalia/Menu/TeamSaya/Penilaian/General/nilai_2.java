...
public class nilai_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nilai_2);
        ...
        btn_selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai_1_.equals("")){
                    ...
                    TAG_KUALITAS_1 = nilai_1_ ;
                    TAG_KUALITAS_2 = nilai_2_ ;
                    TAG_KUALITAS_3 = nilai_3_ ;
                    TAG_KUALITAS_4 = nilai_4_ ;
                    TAG_KUALITAS_5 = nilai_5_ ;

                    sessionManager.createKualitas(nilai_1_,nilai_2_,nilai_3_,nilai_4_,nilai_5_);

                    startActivity(new Intent(mContext,nilai_3.class));
