...
public class Penilaian_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_penilaian_2);
        ...
        btn_selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai_.equals("-- Nilai --")){
                    ...
                    TAG_KUALITAS_1 = Helper.nilaiHurufToNumber(nilai_) ;

                    sessionManager.createKualitas(Helper.nilaiHurufToNumber(nilai_),"","","","");

                    startActivity(new Intent(mContext,Penilaian_3.class));
