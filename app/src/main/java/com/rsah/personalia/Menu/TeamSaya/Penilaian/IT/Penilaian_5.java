...
public class Penilaian_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_penilaian_5);
        ...
        btn_selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai_5_.equals("-- Nilai --")){
                    ...
                    TAG_TANGGUNG_JAWAB_1 = Helper.nilaiHurufToNumber(nilai_5_) ;

                    sessionManager.createTanggung_jawab(Helper.nilaiHurufToNumber(nilai_5_),"","","","","");

                    startActivity(new Intent(mContext,Penilaian_6.class));
