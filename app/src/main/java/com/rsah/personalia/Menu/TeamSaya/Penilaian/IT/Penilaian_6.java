...
public class Penilaian_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_penilaian_6);
        ...
        btn_selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai_.equals("-- Nilai --")){
                    ...
                    TAG_KERAJINAN_1 = Helper.nilaiHurufToNumber(nilai_) ;

                    sessionManager.createKerajinan(Helper.nilaiHurufToNumber(nilai_),"","","","");
