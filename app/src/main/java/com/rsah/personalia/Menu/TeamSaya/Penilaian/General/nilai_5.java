...
public class nilai_5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nilai_5);
        ...
        btn_selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai_1_.equals("")){
                    ...
                    TAG_TANGGUNG_JAWAB_1 = nilai_1_ ;
                    TAG_TANGGUNG_JAWAB_2 = nilai_2_ ;
                    TAG_TANGGUNG_JAWAB_3 = nilai_3_ ;
                    TAG_TANGGUNG_JAWAB_4 = nilai_4_ ;
                    TAG_TANGGUNG_JAWAB_5 = nilai_5_ ;

                    sessionManager.createTanggung_jawab(nilai_1_,nilai_2_,nilai_3_,nilai_4_,nilai_5_,"");

                    startActivity(new Intent(mContext,nilai_6.class));
