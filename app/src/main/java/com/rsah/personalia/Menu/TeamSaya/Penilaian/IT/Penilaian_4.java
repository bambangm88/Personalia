...
public class Penilaian_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_penilaian_4);
        ...
        btn_selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai_5_.equals("-- Nilai --")){
                    ...
                    TAG_KERJA_SAMA_1 = Helper.nilaiHurufToNumber(nilai_5_) ;

                    sessionManager.createKerja_sama(Helper.nilaiHurufToNumber(nilai_5_),"","","","");

                    startActivity(new Intent(mContext,Penilaian_5.class));
