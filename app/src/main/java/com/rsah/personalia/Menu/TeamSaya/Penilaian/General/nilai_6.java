...
public class nilai_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nilai_6);
        ...
        btn_selanjutnya.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (nilai_1_.equals("")){
                    ...
                    TAG_KERAJINAN_1 = nilai_1_ ;
                    TAG_KERAJINAN_2 = nilai_2_ ;
                    TAG_KERAJINAN_3 = nilai_3_ ;
                    TAG_KERAJINAN_4 = nilai_4_ ;
                    TAG_KERAJINAN_5 = nilai_5_ ;

                    sessionManager.createKerajinan(nilai_1_,nilai_2_,nilai_3_,nilai_4_,nilai_5_);
